...
class ControlButtons(tk.Frame):
    ...
    def __init__(self, parent: Menu, control_unit: ControlUnit):
        ...
        self.stop_image =tk.PhotoImage(file='ui/stop_white.png')
        ...
        self.roll_in_button = tk.Button(self, bg='#E6772E', foreground='#EEEEEE', state='disabled', text='Rol in', image=self.retract_image, compound='left', command=self.roll_in, width=120, relief='ridge')
        self.roll_out_button = tk.Button(self, bg='#E6772E', foreground='#EEEEEE', state='disabled', text='Rol uit', image=self.collapse_image, compound='left', command=self.roll_out, width=120, relief='ridge')
        self.stop_roll_button = tk.Button(self, bg='#E6772E', foreground='#EEEEEE', state='disabled', text='Stop', image=self.stop_image, compound='left', command=self.stop_roll, width=120, relief='ridge')
        ...
        self.stop_roll_button.pack(side='left')
    ...
    # Send a stop command to the ControlUnit
    def stop_roll(self):
        self.control_unit.screen_stop_roll()
    ...
    def auto_roll(self):
        ...
        if result:
            ...
            self.stop_roll_button.config(state='disabled')
        else:
            ...
            self.stop_roll_button.config(state='normal')
